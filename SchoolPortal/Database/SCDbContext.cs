...
namespace SchoolPort.Database
{
    ...
    public class SCDbContext : IdentityDbContext<ApplicationUser>
    {
        public SCDbContext()
        ...
        public static SCDbContext Create()
        {
            return new SCDbContext();
        }
        ...
        public DbSet<StudentGrade> StudentGradeList { get; set; }
        public DbSet<SchoolEvent> SchoolEventList { get; set; }
        public DbSet<Country> CountryList { get; set; }        
        public DbSet<CountryState> CountryStateList { get; set; }
        public DbSet<Address> AddressList { get; set; }

        public DbSet<Accounts> AccountsList { get; set; }        
    }
}
